        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
            <div class="container mx-auto px-6 py-2">
                <div class="text-right">
                  @can('Role create')
                    <a href="{{route('admin.roles.create')}}" class="bg-pink-900 text-white font-bold px-5 py-1 rounded focus:outline-none shadow hover:bg-blue-400 rounded-full transition-colors">New Role</a>
                </div>
                @endcan
                    ...
                    @can('Role access')
                      ...
                      <tr class="hover:bg-grey-lighter">
                        ...
                        <td class="py-4 px-6 border-b border-grey-light text-right">
                          ...
                          @can('Role edit')
                          <a href="{{route('admin.roles.edit',$role->id)}}" class="border border-transparent py-1 px-3 hover:border-blue-400 text-blue-400"><span class="fas fa-edit"></span></a>
                          @endcan
